...
PATH = " " #Change this path to the directory on your computer which you want to make accessible by the server

SCRIPT_PATH = " " #Change this path to the location of the downloaded script folder on your computer
